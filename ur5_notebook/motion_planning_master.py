...
class ur5_mp:
    def __init__(self):
        ...
        self.cxy_pub = rospy.Publisher('master/cxy1', Tracker2, queue_size=1)
        self.phase = 1
        self.object_cnt = 0
        ...
        self.arm = moveit_commander.MoveGroupCommander(group_name, "master/robot_description", ns= "master")
    ...
    def cleanup(self):
        rospy.loginfo("Stopping the master robot")
